...
export LANG=C
export SOURCE_DATE_EPOCH=1530507418
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library BiasedUrn|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/BiasedUrn/libs/symbols.rds
